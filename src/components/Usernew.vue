<template>
  ...
  <ul class="nav nav-tabs">
      <li class="nav-item">
       <li class="nav-item">   <router-link to="/user" class="nav-link">Active User</router-link>    &nbsp;</li>
      </li>
      <li class="nav-item">
      <a class="nav-link active" aria-current="page" href="#">Archived User</a>
